...
console.info("CreditCard No.= '9999777788880000'");
 console.log(validateCreditCard('9999777788880000'));

console.info("CreditCard No.= '6666666666661666'"); 
console.log(validateCreditCard('6666666666661666'));

console.info("CreditCard No.= 'a92332119c011112'"); 
console.log(validateCreditCard('a92332119c011112')); 

console.info("CreditCard No.= '4444444444444444'"); 
console.log(validateCreditCard('4444444444444444')); 

console.info("CreditCard No.= '1111111111111110'"); 
console.log(validateCreditCard('1111111111111110'));
 
console.info("CreditCard No.= '6666666666666661'"); 
